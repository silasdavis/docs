...
var languageOptions = [{ title: 'Solidity',
  short: 'sol',
  value: 'solidity' }, { title: 'cURL',
  short: 'cURL',
  value: 'curl' }];
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !col1 && !queryMatches.mobile && _react2.default.createElement(
          'div',
          { className: 'fixed-top fixed-right ' + (queryMatches.desktop && 'space-left24') },
          _react2.default.createElement('div', { className: 'fill-light col5 pin-right' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'fill-dark dark fixed-top ' + (queryMatches.tablet ? 'pad1y pad2x col7 z2 AN-tablet-titlebar' : 'pad1 width24  AN-titlebar') },
          _react2.default.createElement(
            'div',
            { className: '' + (queryMatches.desktop ? 'clearfix' : '') },
            _react2.default.createElement(
              'a',
              { href: '/', className: 'width16', title: '' + (queryMatches.desktop ? _custom.brandNames.desktop : queryMatches.mobile ? _custom.brandNames.mobile : _custom.brandNames.tablet) },
              _react2.default.createElement('img', { src: '/images/AgreementsNetwork_logo.png', alt: '' + (queryMatches.desktop ? _custom.brandNames.desktop : queryMatches.mobile ? _custom.brandNames.mobile : _custom.brandNames.tablet) })
            )
          ),
          _react2.default.createElement(
            'div',
            { className: 'strong small AN-title\n          ' + (queryMatches.mobile ? 'space-left3' : '') + '\n          ' + (queryMatches.tablet ? '' : 'line-height15') },
          ...
          queryMatches.tablet && _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              {
                ...
                className: 'short quiet pin-topright button rcon ' + (showNav ? 'caret-up' : 'caret-down') + ' space-right1' },
              _react2.default.createElement(
                'span',
                { className: 'micro' },
                activeSection
            ...
            showNav && _react2.default.createElement(
              'div',
              {
                className: (queryMatches.tablet ? 'AN-tablet-sidebar' : 'AN-mobile-sidebar') + ' fixed-left fill-dark pin-left col7 scroll-styled space-top5' },
        ...
        queryMatches.desktop && _react2.default.createElement(
          'div',
          { className: 'space-top8 scroll-styled overflow-auto width24 sidebar fixed-left fill-dark dark AN-sidebar' },
          _react2.default.createElement(_navigation2.default, {
            navigationItemClicked: this.navigationItemClicked,
            activeSection: activeSection,
            ast: ast })
        ...
        _react2.default.createElement(
          'div',
          { className: '' + (queryMatches.desktop && 'space-left24') },
          _react2.default.createElement(
            'div',
            { className: col1 ? 'col8 margin1' : '' },
            _react2.default.createElement(_content2.default, {
              leftClassname: col1 ? 'space-bottom4 pad2x prose clip' : 'space-bottom8 col7 pad2x prose clip',
              rightClassname: col1 ? 'space-bottom2 pad2 prose clip fill-light space-top5' : 'space-bottom4 col5 pad2 prose clip fill-light space-top5',
              ast: ast,
        ...
        _react2.default.createElement(
          'div',
          { className: 'fixed-top ' + (queryMatches.desktop && 'space-left24') },
          _react2.default.createElement(
            'div',
            { className: 'events fill-light bottom-shadow pad2x pad1y ' + (queryMatches.desktop && 'AN-desktop-language-slide') + ' ' + (col1 ? '' : 'col5 pin-topright') + ' ' + (queryMatches.tablet ? 'AN-tablet-language-slide' : '') + ' ' + (queryMatches.mobile ? 'space-top8 fixed-topright' : '') },
            _react2.default.createElement(
              'div',
